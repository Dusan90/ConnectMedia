...
// get post details stats promo

export const GetPostDetailsStatsPromoActionRequest = (payload) => {
  return {
    type: types.GET_POST_DETAILS_STATS_PROMO_REQUEST,
    payload,
  };
};

export const GetPostDetailsStatsPromoActionReceive = (payload) => {
  return {
    type: types.GET_POST_DETAILS_STATS_PROMO_RECEIVE,
    payload,
  };
};

export const GetPostDetailsStatsPromoActionError = (payload) => {
  return {
    type: types.GET_POST_DETAILS_STATS_PROMO_ERROR,
    payload,
  };
};
